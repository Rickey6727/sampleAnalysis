...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory48Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_48")
public class TConsumeItemOwnLimitedTimeHistory48 {
