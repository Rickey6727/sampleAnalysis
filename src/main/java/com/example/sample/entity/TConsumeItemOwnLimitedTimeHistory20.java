...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory20Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_20")
public class TConsumeItemOwnLimitedTimeHistory20 {
