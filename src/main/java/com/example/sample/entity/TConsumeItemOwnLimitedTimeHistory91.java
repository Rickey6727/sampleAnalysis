...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory91Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_91")
public class TConsumeItemOwnLimitedTimeHistory91 {
