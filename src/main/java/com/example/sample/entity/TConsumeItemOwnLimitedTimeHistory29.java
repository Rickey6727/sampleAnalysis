...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory29Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_29")
public class TConsumeItemOwnLimitedTimeHistory29 {
