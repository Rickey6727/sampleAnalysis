...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory53Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_53")
public class TConsumeItemOwnLimitedTimeHistory53 {
