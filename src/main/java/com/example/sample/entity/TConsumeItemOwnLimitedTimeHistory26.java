...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory26Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_26")
public class TConsumeItemOwnLimitedTimeHistory26 {
