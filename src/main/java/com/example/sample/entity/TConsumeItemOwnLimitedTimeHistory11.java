...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory11Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_11")
public class TConsumeItemOwnLimitedTimeHistory11 {
