...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory9Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_9")
public class TConsumeItemOwnLimitedTimeHistory9 {
