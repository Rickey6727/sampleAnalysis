...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory27Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_27")
public class TConsumeItemOwnLimitedTimeHistory27 {
