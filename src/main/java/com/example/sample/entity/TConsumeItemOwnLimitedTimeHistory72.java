...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory72Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_72")
public class TConsumeItemOwnLimitedTimeHistory72 {
