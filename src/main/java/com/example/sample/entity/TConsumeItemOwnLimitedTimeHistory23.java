...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory23Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_23")
public class TConsumeItemOwnLimitedTimeHistory23 {
