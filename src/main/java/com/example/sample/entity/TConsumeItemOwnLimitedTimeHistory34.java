...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory34Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_34")
public class TConsumeItemOwnLimitedTimeHistory34 {
