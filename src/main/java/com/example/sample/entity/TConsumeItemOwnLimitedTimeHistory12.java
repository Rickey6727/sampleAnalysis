...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory12Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_12")
public class TConsumeItemOwnLimitedTimeHistory12 {
