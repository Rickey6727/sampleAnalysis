...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory24Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_24")
public class TConsumeItemOwnLimitedTimeHistory24 {
