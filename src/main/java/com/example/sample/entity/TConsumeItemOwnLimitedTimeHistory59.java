...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory59Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_59")
public class TConsumeItemOwnLimitedTimeHistory59 {
