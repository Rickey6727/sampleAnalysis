...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory73Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_73")
public class TConsumeItemOwnLimitedTimeHistory73 {
