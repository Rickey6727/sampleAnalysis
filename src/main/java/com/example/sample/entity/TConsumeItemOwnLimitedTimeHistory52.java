...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory52Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_52")
public class TConsumeItemOwnLimitedTimeHistory52 {
