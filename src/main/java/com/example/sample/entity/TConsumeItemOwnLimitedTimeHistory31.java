...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory31Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_31")
public class TConsumeItemOwnLimitedTimeHistory31 {
