...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory69Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_69")
public class TConsumeItemOwnLimitedTimeHistory69 {
