...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory45Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_45")
public class TConsumeItemOwnLimitedTimeHistory45 {
