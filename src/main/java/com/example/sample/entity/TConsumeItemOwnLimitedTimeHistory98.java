...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory98Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_98")
public class TConsumeItemOwnLimitedTimeHistory98 {
