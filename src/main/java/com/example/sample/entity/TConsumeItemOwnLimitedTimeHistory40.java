...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory40Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_40")
public class TConsumeItemOwnLimitedTimeHistory40 {
