...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory33Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_33")
public class TConsumeItemOwnLimitedTimeHistory33 {
