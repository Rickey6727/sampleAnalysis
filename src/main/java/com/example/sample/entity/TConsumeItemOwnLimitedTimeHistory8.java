...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory8Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_8")
public class TConsumeItemOwnLimitedTimeHistory8 {
