...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory37Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_37")
public class TConsumeItemOwnLimitedTimeHistory37 {
