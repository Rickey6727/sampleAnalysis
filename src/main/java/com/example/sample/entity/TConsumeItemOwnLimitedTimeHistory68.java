...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory68Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_68")
public class TConsumeItemOwnLimitedTimeHistory68 {
