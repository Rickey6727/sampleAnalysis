...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory36Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_36")
public class TConsumeItemOwnLimitedTimeHistory36 {
