...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory35Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_35")
public class TConsumeItemOwnLimitedTimeHistory35 {
