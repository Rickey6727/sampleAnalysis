...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory0Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_0")
public class TConsumeItemOwnLimitedTimeHistory0 {
