...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory97Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_97")
public class TConsumeItemOwnLimitedTimeHistory97 {
