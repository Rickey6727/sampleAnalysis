...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory54Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_54")
public class TConsumeItemOwnLimitedTimeHistory54 {
