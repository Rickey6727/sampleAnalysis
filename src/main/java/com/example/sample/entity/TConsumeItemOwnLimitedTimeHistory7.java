...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory7Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_7")
public class TConsumeItemOwnLimitedTimeHistory7 {
