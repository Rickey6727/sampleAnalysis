...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory17Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_17")
public class TConsumeItemOwnLimitedTimeHistory17 {
