...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory76Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_76")
public class TConsumeItemOwnLimitedTimeHistory76 {
