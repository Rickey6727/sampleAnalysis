...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory95Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_95")
public class TConsumeItemOwnLimitedTimeHistory95 {
