...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory99Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_99")
public class TConsumeItemOwnLimitedTimeHistory99 {
