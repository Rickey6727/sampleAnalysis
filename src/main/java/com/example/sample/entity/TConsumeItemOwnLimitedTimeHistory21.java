...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory21Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_21")
public class TConsumeItemOwnLimitedTimeHistory21 {
