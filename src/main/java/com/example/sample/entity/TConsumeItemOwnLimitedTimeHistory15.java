...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory15Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_15")
public class TConsumeItemOwnLimitedTimeHistory15 {
