...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory80Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_80")
public class TConsumeItemOwnLimitedTimeHistory80 {
