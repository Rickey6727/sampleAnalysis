...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory56Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_56")
public class TConsumeItemOwnLimitedTimeHistory56 {
