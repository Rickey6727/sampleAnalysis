...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory70Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_70")
public class TConsumeItemOwnLimitedTimeHistory70 {
