...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory89Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_89")
public class TConsumeItemOwnLimitedTimeHistory89 {
