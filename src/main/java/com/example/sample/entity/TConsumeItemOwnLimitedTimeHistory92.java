...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory92Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_92")
public class TConsumeItemOwnLimitedTimeHistory92 {
