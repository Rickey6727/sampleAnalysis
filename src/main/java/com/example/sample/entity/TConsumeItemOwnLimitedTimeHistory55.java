...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory55Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_55")
public class TConsumeItemOwnLimitedTimeHistory55 {
