...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory90Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_90")
public class TConsumeItemOwnLimitedTimeHistory90 {
