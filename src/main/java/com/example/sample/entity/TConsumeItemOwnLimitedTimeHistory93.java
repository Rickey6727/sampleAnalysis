...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory93Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_93")
public class TConsumeItemOwnLimitedTimeHistory93 {
