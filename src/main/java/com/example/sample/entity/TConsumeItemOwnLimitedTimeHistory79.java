...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory79Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_79")
public class TConsumeItemOwnLimitedTimeHistory79 {
