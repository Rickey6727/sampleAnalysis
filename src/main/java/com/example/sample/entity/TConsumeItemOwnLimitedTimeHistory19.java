...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory19Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_19")
public class TConsumeItemOwnLimitedTimeHistory19 {
