...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory94Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_94")
public class TConsumeItemOwnLimitedTimeHistory94 {
