...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory62Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_62")
public class TConsumeItemOwnLimitedTimeHistory62 {
