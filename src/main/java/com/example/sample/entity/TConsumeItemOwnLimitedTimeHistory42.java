...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory42Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_42")
public class TConsumeItemOwnLimitedTimeHistory42 {
