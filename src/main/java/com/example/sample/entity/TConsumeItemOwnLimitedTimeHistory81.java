...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory81Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_81")
public class TConsumeItemOwnLimitedTimeHistory81 {
