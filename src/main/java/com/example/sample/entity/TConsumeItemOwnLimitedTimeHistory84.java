...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory84Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_84")
public class TConsumeItemOwnLimitedTimeHistory84 {
