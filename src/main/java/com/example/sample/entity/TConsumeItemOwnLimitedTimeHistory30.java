...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory30Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_30")
public class TConsumeItemOwnLimitedTimeHistory30 {
