...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory44Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_44")
public class TConsumeItemOwnLimitedTimeHistory44 {
