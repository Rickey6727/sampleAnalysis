...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory14Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_14")
public class TConsumeItemOwnLimitedTimeHistory14 {
