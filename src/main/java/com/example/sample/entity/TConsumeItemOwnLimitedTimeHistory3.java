...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory3Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_3")
public class TConsumeItemOwnLimitedTimeHistory3 {
