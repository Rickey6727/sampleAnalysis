...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory2Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_2")
public class TConsumeItemOwnLimitedTimeHistory2 {
