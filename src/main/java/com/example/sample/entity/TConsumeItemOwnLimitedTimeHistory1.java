...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory1Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_1")
public class TConsumeItemOwnLimitedTimeHistory1 {
