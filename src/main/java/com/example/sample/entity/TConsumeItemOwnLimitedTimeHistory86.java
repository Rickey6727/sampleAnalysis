...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory86Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_86")
public class TConsumeItemOwnLimitedTimeHistory86 {
