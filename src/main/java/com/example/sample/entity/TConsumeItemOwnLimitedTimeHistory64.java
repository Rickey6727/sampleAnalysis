...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory64Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_64")
public class TConsumeItemOwnLimitedTimeHistory64 {
