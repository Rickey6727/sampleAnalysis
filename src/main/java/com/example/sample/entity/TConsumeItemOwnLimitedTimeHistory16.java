...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory16Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_16")
public class TConsumeItemOwnLimitedTimeHistory16 {
