...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory67Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_67")
public class TConsumeItemOwnLimitedTimeHistory67 {
