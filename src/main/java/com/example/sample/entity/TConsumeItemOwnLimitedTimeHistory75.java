...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory75Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_75")
public class TConsumeItemOwnLimitedTimeHistory75 {
