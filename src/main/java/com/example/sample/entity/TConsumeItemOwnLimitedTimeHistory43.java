...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory43Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_43")
public class TConsumeItemOwnLimitedTimeHistory43 {
