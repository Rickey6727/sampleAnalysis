...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory57Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_57")
public class TConsumeItemOwnLimitedTimeHistory57 {
