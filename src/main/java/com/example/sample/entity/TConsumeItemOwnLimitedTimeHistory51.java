...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory51Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_51")
public class TConsumeItemOwnLimitedTimeHistory51 {
