...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory46Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_46")
public class TConsumeItemOwnLimitedTimeHistory46 {
