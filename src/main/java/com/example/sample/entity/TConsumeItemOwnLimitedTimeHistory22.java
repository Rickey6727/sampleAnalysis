...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory22Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_22")
public class TConsumeItemOwnLimitedTimeHistory22 {
