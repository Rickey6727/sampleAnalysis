...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory18Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_18")
public class TConsumeItemOwnLimitedTimeHistory18 {
