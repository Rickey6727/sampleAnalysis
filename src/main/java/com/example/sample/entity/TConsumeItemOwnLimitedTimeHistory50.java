...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory50Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_50")
public class TConsumeItemOwnLimitedTimeHistory50 {
