...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory58Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_58")
public class TConsumeItemOwnLimitedTimeHistory58 {
