...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory6Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_6")
public class TConsumeItemOwnLimitedTimeHistory6 {
