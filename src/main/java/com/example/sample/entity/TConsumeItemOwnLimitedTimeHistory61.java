...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory61Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_61")
public class TConsumeItemOwnLimitedTimeHistory61 {
