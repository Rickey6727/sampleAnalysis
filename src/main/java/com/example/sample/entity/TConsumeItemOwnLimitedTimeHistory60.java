...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory60Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_60")
public class TConsumeItemOwnLimitedTimeHistory60 {
