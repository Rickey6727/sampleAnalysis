...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory32Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_32")
public class TConsumeItemOwnLimitedTimeHistory32 {
