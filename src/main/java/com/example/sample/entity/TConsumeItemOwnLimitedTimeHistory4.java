...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory4Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_4")
public class TConsumeItemOwnLimitedTimeHistory4 {
