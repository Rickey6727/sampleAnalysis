...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory82Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_82")
public class TConsumeItemOwnLimitedTimeHistory82 {
