...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory71Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_71")
public class TConsumeItemOwnLimitedTimeHistory71 {
