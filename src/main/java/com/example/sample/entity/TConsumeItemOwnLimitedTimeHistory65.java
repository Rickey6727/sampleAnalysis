...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory65Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_65")
public class TConsumeItemOwnLimitedTimeHistory65 {
