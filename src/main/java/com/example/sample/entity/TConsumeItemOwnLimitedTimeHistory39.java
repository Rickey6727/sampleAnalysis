...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory39Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_39")
public class TConsumeItemOwnLimitedTimeHistory39 {
