...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory78Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_78")
public class TConsumeItemOwnLimitedTimeHistory78 {
