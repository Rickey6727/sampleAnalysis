...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory83Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_83")
public class TConsumeItemOwnLimitedTimeHistory83 {
