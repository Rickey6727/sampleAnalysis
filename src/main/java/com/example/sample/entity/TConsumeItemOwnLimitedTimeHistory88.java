...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory88Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_88")
public class TConsumeItemOwnLimitedTimeHistory88 {
