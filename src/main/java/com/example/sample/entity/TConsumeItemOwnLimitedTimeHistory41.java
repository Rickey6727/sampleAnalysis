...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory41Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_41")
public class TConsumeItemOwnLimitedTimeHistory41 {
