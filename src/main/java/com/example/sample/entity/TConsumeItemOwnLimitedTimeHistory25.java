...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory25Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_25")
public class TConsumeItemOwnLimitedTimeHistory25 {
