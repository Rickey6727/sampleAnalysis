...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory66Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_66")
public class TConsumeItemOwnLimitedTimeHistory66 {
