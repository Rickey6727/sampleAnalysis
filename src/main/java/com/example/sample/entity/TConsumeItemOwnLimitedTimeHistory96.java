...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory96Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_96")
public class TConsumeItemOwnLimitedTimeHistory96 {
