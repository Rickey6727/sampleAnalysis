...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory47Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_47")
public class TConsumeItemOwnLimitedTimeHistory47 {
