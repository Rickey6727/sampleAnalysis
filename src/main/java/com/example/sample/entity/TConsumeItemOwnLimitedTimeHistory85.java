...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory85Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_85")
public class TConsumeItemOwnLimitedTimeHistory85 {
