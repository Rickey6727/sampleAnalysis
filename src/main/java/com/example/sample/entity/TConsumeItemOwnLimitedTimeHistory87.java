...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory87Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_87")
public class TConsumeItemOwnLimitedTimeHistory87 {
