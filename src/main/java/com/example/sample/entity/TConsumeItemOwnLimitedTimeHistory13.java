...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory13Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_13")
public class TConsumeItemOwnLimitedTimeHistory13 {
