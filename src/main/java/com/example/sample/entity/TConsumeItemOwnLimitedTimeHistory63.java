...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory63Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_63")
public class TConsumeItemOwnLimitedTimeHistory63 {
