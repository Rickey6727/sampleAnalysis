...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory28Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_28")
public class TConsumeItemOwnLimitedTimeHistory28 {
