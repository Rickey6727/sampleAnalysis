...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory77Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_77")
public class TConsumeItemOwnLimitedTimeHistory77 {
