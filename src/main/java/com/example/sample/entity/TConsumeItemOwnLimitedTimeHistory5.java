...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory5Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_5")
public class TConsumeItemOwnLimitedTimeHistory5 {
