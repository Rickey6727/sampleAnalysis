...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory74Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_74")
public class TConsumeItemOwnLimitedTimeHistory74 {
