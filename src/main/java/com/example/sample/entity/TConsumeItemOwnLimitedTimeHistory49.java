...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory49Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_49")
public class TConsumeItemOwnLimitedTimeHistory49 {
