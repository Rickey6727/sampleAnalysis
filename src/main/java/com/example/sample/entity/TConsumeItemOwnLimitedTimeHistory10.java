...
/**
 */
@Entity(listener = TConsumeItemOwnLimitedTimeHistory10Listener.class)
@Table(name = "t_consume_item_own_limited_time_history_10")
public class TConsumeItemOwnLimitedTimeHistory10 {
